...
file.spglobal=read.csv("C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/final_combined_review.csv")

filter_data <- subset(file.spglobal, file.spglobal$Current.Job == 'Yes')

n = min(nrow(filter_data))


############# Cleaning Pros Data

data_pros = data.frame(text1 = filter_data$Pros[1:n],
...
data_cons = data.frame(text1 = filter_data$Cons[1:n],
                       #text2 = file.mi$text[1:n],
                       #text3 = file.lin$text[1:n],
                       stringsAsFactors = F)
dim(data_cons)
