...
write.csv(df_final_dataset, file = "C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/MSCI/MSCI_pros_withratings_oth_1.csv")
...
#df_final_dataset_cons <- df_cons_overall
#write.table(as.data.frame(com_pros_list),file="C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/MSCI/FactSet_pros.csv", quote=F,sep=",",row.names=F)
write.csv(df_final_dataset_cons, file = "C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/MSCI/MSCI_cons_withratings.csv")
