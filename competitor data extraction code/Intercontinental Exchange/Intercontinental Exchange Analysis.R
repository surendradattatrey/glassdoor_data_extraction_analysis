...
file.spglobal.pros=read.csv("C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Intercontinental Exchange/Intercontinental Exchange_pros_withratings.csv")
file.spglobal.cons=read.csv("C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Intercontinental Exchange/Intercontinental Exchange_cons_withratings.csv")
...
unique(file.spglobal.pros$pros_page_rating_value)
