...
write.csv(df_final_dataset, file = "C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Intercontinental Exchange/Intercontinental Exchange_pros_withratings.csv")
...
#write.table(as.data.frame(com_pros_list),file="C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/Code/competitor data extraction code/FactSet_pros.csv", quote=F,sep=",",row.names=F)
write.csv(df_final_dataset_cons, file = "C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Intercontinental Exchange/Intercontinental Exchange_cons_withratings.csv")
