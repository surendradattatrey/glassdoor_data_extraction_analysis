...
for(i in 2:total_pages_to_read )  #####  total_pages_to_read
{
  print(i)
  baseurl <- "https://www.glassdoor.com/Reviews/Company-Reviews-"
  companyNum <- "E3096_P"
...
write.csv(df_final_dataset, file = "C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Bloomberg/Bloomberg_pros_with_rating.csv")
...
write.csv(df_final_dataset_cons, file = "C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Bloomberg/Bloomberg_cons_with_rating.csv")
