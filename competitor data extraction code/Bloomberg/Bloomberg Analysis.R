...
file.spglobal.pros=read.csv("C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Bloomberg/Bloomberg_pros_with_rating.csv")
file.spglobal.cons=read.csv("C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Bloomberg/Bloomberg_cons_with_rating.csv")
...
title(sub = "Bloomberg - Top words in Pros")
...
filter_data <- subset(file.spglobal.pros, file.spglobal.pros$pros_page_rating_value == 2)
file.spglobal.pros
