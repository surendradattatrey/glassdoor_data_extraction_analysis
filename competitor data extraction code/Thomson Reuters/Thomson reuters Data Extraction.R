...
for(i in 716:total_pages_to_read )  #####  total_pages_to_read-60
{
  print(i)
  baseurl <- "https://www.glassdoor.com/Reviews/Company-Reviews-"
    companyNum <- "E100303_P"
...
df_pros_overall_1 <- df_pros_overall
df_pros_overall_2 <- df_pros_overall
df_pros_overall_3 <- df_pros_overall
...
unique(df_final_dataset$pros_page_rating_value)
...
write.csv(df_final_dataset, file = "C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Thomson Reuters/Thomson Reuters_pros_withratings.csv")
...
#####################################################  Page 2 to all page reading Cons data extraction   #######################################
cons_list <- list()
...
for(i in 833:total_pages_to_read )  #####  total_pages_to_read-60
{
  print(i)
  baseurl <- "https://www.glassdoor.com/Reviews/Company-Reviews-"
  companyNum <- "E100303_P"
...
df_cons_overall_1 <- df_cons_overall
df_cons_overall_2 <- df_pros_overall
df_cons_overall_3 <- df_pros_overall

names(df_cons_overall)[1]<-paste("cons_page1")
df_final_dataset_cons <- rbind(cons_first_page_review,df_cons_overall)
#write.table(as.data.frame(com_pros_list),file="C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/Code/competitor data extraction code/FactSet_pros.csv", quote=F,sep=",",row.names=F)
write.csv(df_final_dataset_cons,file = "C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Thomson Reuters/Thomson Reuters_cons_withratings.csv")
