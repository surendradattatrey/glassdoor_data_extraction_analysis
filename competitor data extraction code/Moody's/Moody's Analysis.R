...
file.spglobal.pros=read.csv("C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Moody's/Moodys_pros_withratings.csv")
file.spglobal.cons=read.csv("C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Moody's/Moodys_cons_withratings.csv")
