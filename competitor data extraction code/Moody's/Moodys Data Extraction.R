...
write.csv(df_final_dataset, file = "C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Moody's/Moodys_pros_withratings.csv")
...
#   
#   df_page <- read_html(paste(baseurl, companyNum,page_number, sort, sep = ""))
#   Cons_oth <- html_nodes(df_page,".common__EiReviewTextStyles__allowLineBreaks:nth-child(7) .strong+ p")
#   #.common__EiReviewTextStyles__allowLineBreaks:nth-child(6) .strong+ p
#   Cons_list <- html_text(Cons_oth)
#   Cons_list_rating_val <- html_attr(html_nodes(df, ".gdStars.gdRatings.sm .rating .value-title"), "title")
#   print(Cons_list)
...
df_final_dataset_cons <- (df_cons_overall)#write.table(as.data.frame(com_pros_list),file="C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/Code/competitor data extraction code/FactSet_pros.csv", quote=F,sep=",",row.names=F)
write.csv(df_final_dataset_cons, file = "C:/Users/surendra_dattatrey/Desktop/S&P Data/Glassdoor/competitor data extraction code/Moody's/Moodys_cons_withratings.csv")
